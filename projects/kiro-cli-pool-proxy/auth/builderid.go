...
// BuilderIdSession is an AWS Builder ID device-code login session.
...
// StartBuilderIdLogin begins an AWS Builder ID device-code login.
...
// PollBuilderIdAuth polls the Builder ID authorization status.
...
// GetBuilderIdSession returns session info by ID.
...
// cleanupExpiredBuilderIdSessions removes expired sessions.
